...
<CardGroup cols={2}>
  ...
  <Card title="Pattern Groups" icon="layer-group" color="#07edb5">
    Organize patterns into groups for easier management and rule assignment.
  </Card>
  <Card title="Pattern Validation" icon="check-circle" color="#07edb5">
    Validate patterns against sample data to ensure accurate detection.
  </Card>
</CardGroup>
